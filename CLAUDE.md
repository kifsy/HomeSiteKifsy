...
- **2026-05-21** · Add bilingual team section to contact.html (Ron/Doron founder cards); every element has data-he/data-en so names, initials, roles, and bios all switch with the language toggle.
- **2026-05-21** · Fix static screenshot previews (BebKey, ramtours): switch from scale(0.275) transform to object-fit:cover so images fill the browser mockup properly.
